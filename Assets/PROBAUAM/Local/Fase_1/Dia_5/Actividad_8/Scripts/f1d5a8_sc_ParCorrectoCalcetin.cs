...
public class f1d5a8_sc_ParCorrectoCalcetin : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("Par3"))
        {
            puntos.sumarPuntos();
        }
        else if (collision.gameObject.CompareTag("Par2") ||
            collision.gameObject.CompareTag("Par1") || collision.gameObject.CompareTag("Par4") ||
